		...
		if (isDirty) {
			...
			if (GetMode() == PhenoGenoEnum.Phenotype) {
				if (cellAndGenePanel.cell != null) {
					...
					GlobalSettings.instance.phenotype.leafCell.exposureFactorAtSpeed.Evaluate(0) * 100f,
					GlobalSettings.instance.phenotype.leafCell.exposureFactorAtSpeed.Evaluate(20) * 100f);
				}
